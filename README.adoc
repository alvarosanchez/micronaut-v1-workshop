...
TIP: Mocking services is technically possible with Micronaut, however, it would
complicate unnecessarily the tests setup, so for the sake of simplicity, we are
using a real instance of the `clubs` service.
